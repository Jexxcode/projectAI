...
def activation_function(predictions):
    classes = ["Consonne", "Voyelle", "Chiffre"]
...
def main():
    ...
    model = load_model("TensorFlow/ClassificationMulticlasse/ChiffreConsonneVoyelle/modele_multiclasse.h5")

    # Charger le Tokenizer
    with open('TensorFlow/ClassificationMulticlasse/ChiffreConsonneVoyelle/tokenizer.pkl', 'rb') as f:
