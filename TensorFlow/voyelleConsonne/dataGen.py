...
with open("C:/Users/Jeffrey/Documents/GitHub/projectAI/TensorFlow/voyelleConsonne/consonne.txt", "w") as file_consonne:
    for _ in range(10000):
        consonne = generer_consonne()
        file_consonne.write(consonne + "\n")

# Générer et écrire 10 000 voyelles dans le fichier voyelle.txt
with open("C:/Users/Jeffrey/Documents/GitHub/projectAI/TensorFlow/voyelleConsonne/voyelle.txt", "w") as file_voyelle:
    for _ in range(10000):
