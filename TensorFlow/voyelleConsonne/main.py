...
def preprocess_input(input_str):
    if input_str.isdigit() or input_str.isalpha():
        ...
        print("Input doit être une seule lettre.")
        return None
...
def main():
    ...
    with open('C:/Users/Jeffrey/Documents/GitHub/projectAI/TensorFlow/voyelleConsonne/consonne.txt', 'r') as f:
        words_letters = f.readlines()

    with open('C:/Users/Jeffrey/Documents/GitHub/projectAI/TensorFlow/voyelleConsonne/voyelle.txt', 'r') as f:
    ...
    model.save("C:/Users/Jeffrey/Documents/GitHub/projectAI/TensorFlow/voyelleConsonne/VoyelleConsonneAI.h5")

    # Sauvegarder le Tokenizer
    with open('C:/Users/Jeffrey/Documents/GitHub/projectAI/TensorFlow/voyelleConsonne/tokenizer.pkl', 'wb') as f:
